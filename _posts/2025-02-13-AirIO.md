...
之前博客[Paper Survey之——Deep IMU-Bias Inference](https://gohan.github.io/Deep-IMU-Bias/)对基于learning的IMU odometry进行了调研及学习，并且也复现了[AirIMU: Learning uncertainty propagation for inertial odometry](https://gohan.github.io/AirIMU/)工作对应IMU的补偿，发现效果非常惊艳（虽然泛化能力还有待提升）
...
通过结合他们的前作[AirIMU](https://gohan.github.io/Deep-IMU-Bias/#airimu-learning-uncertainty-propagation-for-inertial-odometry)（IMU correction model）和EKF，提出AirIO来实现无人机在剧烈飞行状态下的位姿估计，无需额外的sensor或者控制输入（比如thrust commands）.
EKF是用于整合IMU预积分以及所学习的IMU correction model的

从下面效果来看还是比较impressive的，仅仅依靠IMU即可实现稳定的状态估计

<div align="center">
<video playsinline autoplay loop muted src="https://air-io.github.io/video/blackbird_for_web.mov" poster="https://gohan.github.io/File/Representative_works/loading-icon.gif" alt="sym" width="80%" style="padding-top:0px;padding-bottom:0px;border-radius:15px;"></video>
</div>
...
<div align="center">
  <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213155232.png" width="60%" />
<figcaption>  
  ...
  <table style="border: none; background-color: transparent;">
    <tr>
      <td style="width: 50%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213150331.png" width="100%" />
      </td>
      <td style="width: 50%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213150508.png" width="100%" />
      </td>
    </tr>
  </table>
  <figcaption>
...
<div align="center">
  <table style="border: none; background-color: transparent;">
    <tr>
      <td style="width: 50%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213150951.png" width="100%" />
      </td>
      <td style="width: 50%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213151202.png" width="100%" />
      </td>
    </tr>
  </table>
...
<div align="center">
  <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213153525.png" width="60%" />
<figcaption>  
</figcaption>
</div>
...
状态空间$X$定义如下
<div align="center">
  <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213154030.png" width="60%" />
<figcaption>  
</figcaption>
</div>
而error-state representation of the current filter state为：
<div align="center">
  <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213154112.png" width="60%" />
<figcaption>  
</figcaption>
</div>
...
<div align="center">
  <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213154310.png" width="60%" />
<figcaption>  
</figcaption>
</div>
...
而EKF的传播模型则如下：
<div align="center">
  <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213154531.png" width="60%" />
<figcaption>  
</figcaption>
</div>
...
<div align="center">
  <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213154621.png" width="60%" />
<figcaption>  
</figcaption>
</div>
...
<div align="center">
  <img src="https://gohan.github.io/ubuntu_md_blog/images/微信截图_20250213181259.png" width="60%" />
<figcaption>  
</figcaption>
</div>
...
* [Paper Survey之——Deep IMU-Bias Inference](https://gohan.github.io/Deep-IMU-Bias/#airimu-learning-uncertainty-propagation-for-inertial-odometry)
* [Paper Survey: Learning-based VO and VIO](https://gohan.github.io/File/Blogs/Poster/Learning_based_VO.html)