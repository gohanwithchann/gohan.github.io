...
6. 出现Sophus相关的报错.在"/home/gohan/catkin_ws/src/rpg_vikit/vikit_common/CMakeLists.txt"中添加下面代码即可
...
修改launch文件直接开启的时候播包会方便些，修改代码请见[link](https://github.com/gohan/Fast-LIVO2_comment/blob/main/launch/mapping_avia.launch)
...
<!-- # 代码解读
代码解读部分直接将注释添加到代码中，具体请见：[Fast-LIVO2代码解读](https://github.com/gohan/Fast-LIVO2_comment) -->


# 参考资料
* [FAST-LIVO2 Github](https://github.com/hku-mars/FAST-LIVO2)
* [paper link](https://arxiv.org/pdf/2408.14035)
* [Fast-LIVO Self Comment](https://github.com/gohan/fast_livo_comment)
