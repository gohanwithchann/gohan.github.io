...
<div align="center" style="
  ...
  <iframe width="100%" height="100%"
    src="https://gohan.github.io/awesome_NeRF_SLAM/学习笔记之——NeRF SLAM（基于神经辐射场的SLAM）-CSDN博客_files/Survey for 3DGS-SLAM.pdf#toolbar=0&navpanes=0&scrollbar=0" ></iframe>
</div>
...
|2025|`TIM`|[LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting](https://ieeexplore.ieee.org/abstract/document/10926911)|---|[website](https://gohan.github.io/LVI-GS/)|
...
* [Our LVI-GS work](https://gohan.github.io/LVI-GS/)
* [Previous Survey for 3DGS-SLAM](https://gohan.github.io/File/Blogs/Poster/survey_3DGS_SLAM.html)
